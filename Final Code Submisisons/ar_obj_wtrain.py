# Performs Augmented Reality of 3D objects from OBJ file format on the Rubik's cube
...
class VideoPlayer:
    ...
    Estimates the pose from the tracked bounding boxes
    '''
    def __init__(self):
    ...
    def draw_model(self, image, tracked):
        '''
        Projects simple 3D models from world frame onto the image frame
        '''
    ...
    def render_obj(self, image, obj, tracked, color=False):
        '''
        Renders the object from the obj file onto the face of the Rubik's cube
        Uses Projection matrix to project the vertices onto the image plane
        '''
    ...
    def hex_to_rgb(hex_color):
        '''
        converts hexadecimals to RGB values
        '''
    ...
    def projection_matrix(camera_parameters, homography):
        '''
        Finds the projection matrix given the intrinsic matrix and the homography matrix
        '''
        # A[R1 R2 T] = H        
