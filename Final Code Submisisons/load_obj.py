# Extracts vertices and faces from OBJ files
# Reference: https://inareous.github.io/posts/opening-obj-using-py, 
...
class objLoader:
    '''
    Extracts vertices and faces from OBJ format files
    '''
    ...
    def decide_face_color(self, hex_color, texture, textures):
        '''
        Extract colours from texture images
        '''
