# Estimates the Pose of the camera using Perspective N Point algorithm
...
class VideoPlayer:
    ...
    def rect_cb(self, rect):
        '''
        adds bounding box for reference images
        '''
    ...
    def estimate_pose(self, image, tracked):
        '''
        Estimates the pose of the object using Perspective and Point algorithm, otherwise known as PnP problem
        '''
    ...
    def draw_axis(img, corner, imgpts):
        '''
        Draws the world frame axis on the image (Top left corner of the Rubik's cube)
        '''
